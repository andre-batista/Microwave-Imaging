...
switch initopt
    ...
    otherwise
        load ../../../../../../Documents/MATLAB/inverse-approximation/g-ricardo.mat C g d   
end
...
for it = 1:maxit
    ...
    GD = diag(diag(gd*del_C));
    L_delta_C = I + GD + gd2*del_C*del_C;
    
    LC = LC + L_delta_C + gdC*GD + GD*gdC - I;
...
savefig('h-ricardo.fig')

% Saving solution
save ../../../../../../Documents/MATLAB/inverse-approximation/h-ricardo.mat C cnvg totaltime -v7.3
...
switch initopt
    ...
    otherwise
        load ../../../../../../Documents/MATLAB/inverse-approximation/e-ricardo.mat C g d   
end
...
LC      = I+GD+C*diGdi*C + didi*D2 + Gdidi*D2;  % Initial inversion
...
for it = 1:maxit
    ...
    GD = gd*C;
    D2 = C*C;
    LC = I+GD+C*diGdi*C+didi*D2+Gdidi*D2;
...
savefig('e-ricardofig.fig')

% Saving solution
save ../../../../../../Documents/MATLAB/inverse-approximation/e-ricardo.mat C totaltime cnvg -v7.3
...
fprintf             ('Setting model pr?operties and parameters... ');
expname             = 'basic_exp03_robustness_05';
SNR                 = 25;                   % Signal-to-Noise Ratio
geometryname        = 'ring';               % Geometry name
...
ra                  = 10.5e-2;              % Outer radius [m]
rb                  = 6.75e-2;              % Inner radius [m]
rc                  = 2.25e-2;              % Circle radius [m]
del                 = 3.75e-2;              % Displacement between two ellipses [m]
frequency           = [8e8,1e9,2e9];        % Frequency of measurements [Hz]
...
sfi                 = {1:3};                % Set of frequency indexes          

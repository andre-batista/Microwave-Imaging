...
expname             = 'basic_exp04_02_filledring';
geometryname        = 'filledring';         % Geometry name
...
epsilon_robj        = [1.5,2.];             % Object relative permittivity
sigma_obj           = [0,0,0];              % Object conductivity [S/m]
ra                  = 10.5e-2;              % Ring radius [m]
rb                  = 7.5e-2;               % Circle radius [m]
...
testbench = getmap(geometryname,finemodel,epsilon_robj,sigma_obj,ra,rb);
fprintf('ok!\n')

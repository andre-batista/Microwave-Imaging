...
expname             = 'basic_exp04_01_2circles';
geometryname        = '2circles';           % Geometry name
...
epsilon_robj        = [1.5,1.8,2.];         % Object relative permittivity
sigma_obj           = [0,0,0];              % Object conductivity [S/m]
ra                  = 6e-2;                 % Circle radius [m]
del                 = 3e-2;                 % Displacement of the circles [m]
...
testbench = getmap(geometryname,finemodel,epsilon_robj,sigma_obj,ra,del);
fprintf('ok!\n')
